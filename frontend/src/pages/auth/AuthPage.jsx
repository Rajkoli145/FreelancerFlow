      ...
      <div className="main">
        ...
        <div className="container a-container" id="a-container">
          <form className="form" onSubmit={handleSignUp}>
            ...
            <div className="form__icons">
              <button type="button" className="form__icon-btn" aria-label="Sign up with Google">
              ...
              <button type="button" className="form__icon-btn" aria-label="Sign up with LinkedIn">
                <Linkedin className="form__icon" strokeWidth={1.5} />
              </button>
              <button type="button" className="form__icon-btn" aria-label="Sign up with GitHub">
        ...
        <div className="container b-container" id="b-container">
          <form className="form" onSubmit={handleSignIn}>
            ...
            <div className="form__icons">
              <button type="button" className="form__icon-btn" aria-label="Sign in with Google">
                <svg className="form__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
                  <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
                  <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
              ...
              <button type="button" className="form__icon-btn" aria-label="Sign in with LinkedIn">
                <Linkedin className="form__icon" strokeWidth={1.5} />
              </button>
              <button type="button" className="form__icon-btn" aria-label="Sign in with GitHub">
                <Github className="form__icon" strokeWidth={1.5} />
              </button>
            </div>
