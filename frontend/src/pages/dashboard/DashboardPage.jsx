                ...
                >
                  <div className="py-2">
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-sm hover:bg-white/40 ${earningsTimeRange === '1month' ? 'font-semibold' : ''
                        }`}
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-sm hover:bg-white/40 ${earningsTimeRange === '6months' ? 'font-semibold' : ''
                        }`}
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-sm hover:bg-white/40 ${earningsTimeRange === '1year' ? 'font-semibold' : ''
                        }`}
                ...
                >
                  <div className="py-2">
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-sm hover:bg-white/40 ${productivityTimeRange === '4weeks' ? 'font-semibold' : ''
                        }`}
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-sm hover:bg-white/40 ${productivityTimeRange === '12weeks' ? 'font-semibold' : ''
                        }`}
